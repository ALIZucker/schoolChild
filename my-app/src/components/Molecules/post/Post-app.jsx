...
function PostApp(props) {
    return (
        <div
            ...
            <img src={img} className="m-[8px] w-full h-[201px] mt-4"/>
            <section className="flex w-full flex-row-reverse px-4 rounded-[10px] justify-between">
                <p className="text-backCfirst Faceface text-[10px] px-4 py-1 bg-backseced  font-semibold ">ریاضی
                    هفتم</p>
            ...
            <h2 className="mt-4  Faceface mx-4 text-text16 font-bold text-textsecenf">فصل چهارم: هندسه و استدلال درس هفتم: هندسه و
                استدلال</h2>
            ...
            <div className="flex flex-row mt-2 items-center gap-2 justify-end px-5  w-full ">
                <span className="Faceface text-[1.3889vw]">تومان</span><p className="text-[1.6667vw] Faceface font-bold"> ۶,۸۸۰,۰۰۰</p>
            </div>
        </div>
    );
}
